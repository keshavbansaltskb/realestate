...
export default function page(){
    ...
    function next(){
        if(amount=="" || amounttype=="" || propertyfor=="" || description=="" || bhk=="" || selectedState=="" || selectedCity==""){
